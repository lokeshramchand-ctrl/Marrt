...
import 'package:seko/pages/fruits.dart';
import 'package:seko/test/ProductDetailPage.dart';

class Greenies extends StatefulWidget {
  const Greenies({super.key});

  @override
  State<Greenies> createState() => _GreeniesState();
}

class _GreeniesState extends State<Greenies> {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => ProductDetailPage(
            image: item['image'],
            label: item['label'],
            price: item['price'], // Now the price is a double
          ),
        ),
      );
    }
