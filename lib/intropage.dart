...
import 'package:seko/signuppage.dart';
          ...
          Padding(
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  Image.asset(
                    "assets/48.png", // Replace with your logo image path
                    height: 100, // Set the height of the logo
                    fit: BoxFit.contain, // Adjust fit as needed
                  ),
                  const SizedBox(height: 20), // Space between logo and text
                  Text(
                    'Welcome to Mart!', // Text below the logo
                  ...
                  Text(
                    'Mart to Person', // Text below the logo
                    style: GoogleFonts.albertSans(
                      fontSize: 16,
